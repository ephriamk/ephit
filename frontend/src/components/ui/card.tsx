  ...
  return (
    <div
      ...
      className={cn(
        ...
        "before:absolute before:inset-0 before:rounded-3xl before:bg-gradient-to-br before:from-[#4A90E2]/10 before:via-[#2E66B5]/8 before:to-[#1C3E75]/10 before:opacity-0 before:transition-opacity before:duration-300 hover:before:opacity-100",
        className
      )}
      {...props}
    />
